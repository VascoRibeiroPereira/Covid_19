...
PT_CN_merged_Graph_Cases <- gPT_CN_Cases + geom_line(aes(color = GeoId)) + coord_cartesian(ylim = c(0, 4000)) + labs(x = "Days") + labs(y = "Cases") + labs(title = "Portugal vs China new cases rate") + theme(plot.title = element_text(hjust = 0.5))
